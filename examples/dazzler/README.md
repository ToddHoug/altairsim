...
- **Build this machine yourself.** `recipes/dazzler-from-scratch.pdf` fits every board of it by
  hand, starting from an empty chassis, and saves the result to a machine file of your own.
