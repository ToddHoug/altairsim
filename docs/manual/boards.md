...
with a console to type at. The ACRTC's larger commands — circles, arcs, paint, pattern and area
copies — are recognized but not yet drawn; the board says so in its status register, and the
