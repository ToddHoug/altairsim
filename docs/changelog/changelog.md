...
polylines, circles, ellipses, arcs, filled rectangles, dots, block clears, block copies and word
transfers, in every operation, color and area mode), the picture scans out at 8 bits per pixel through the Bt453's table onto a **fixed VESA
...
gets it for free. Paint, patterns and graphic copies are recognized but not drawn yet.
