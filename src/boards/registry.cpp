...
std::vector<BoardType> boardTypes() {
    return {
        ...
        {"pmmi", "PMMI MM-103: Bell 103 modem", "PMMI MM-103: Bell 103 modem on an S-100 card, unit 'line'. Four ports at BASE+0..3 (default C0), read/write different registers. Transmit/receive over a ByteStream; CONNECT it to in:/out: files. No dialer; modem status is a fixed stub"},
